            ...
            <div id="contact">
                ...
                <div id="form">
                    <form action="send.php" method="post">
                        <?php 
                        if($_GET["send"]=="no"){
                            echo "<h1 class='alert'> Настана грешка </h1>";
                        }else if($_GET["send"]=="yes"){
                            echo "<h1 class='alert success'> Вашата порака е испратена </h1>";
                        }
                        else{
                            echo "<h1>Ве молам внесете ги потребните податоци</h1>";
                        }
                        ?>
